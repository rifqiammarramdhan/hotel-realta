...
const EditModal = ({ stockId, stockData }) => {
  ...
  const editStockHandler = async (e) => {
    e.preventDefault();

    try {
      await axios.put(`http://localhost:3005/purchasing/stock?id=${stockId}`, {
      ...
      <div className="modal-dialog modal-dialog-centered modal-lg">
        <div className="modal-content">
          ...
          <div className="modal-body">
            <form onSubmit={editStockHandler}>
              <div className="row">
                ...
                <div class="col-md-3 mb-3">
                  ...
                  <input type="text" onChange={(e) => setSize(e.target.value)} class="form-control" id="size" placeholder="A1" required />
                </div>
